...
bash_prompt() {
	...
	local PROMT_HOST=$"$TEXT_FORMAT_2 \u@popOS"
	...
	*)
	...
	#PS1="$TITLEBAR\n${PROMT_USER}${PROMT_HOST}${PROMT_PWD}\n${SEPARATOR_3}${PROMT_INPUT}"
...
alias pt=python3
alias cdpt="cd ~/LocalGit/python"
alias cdabb="cd ~/LocalGit/ABB"
alias cdard="cd ~/LocalGit/Arduino"
alias sesja="lwsm restore micro"
alias o="xdg-open"
alias v="sxiv"
alias dyski="lsblk"
alias mcc="terminology -e mc &"
